...
@Controller
@SessionAttributes(
        value = {CurriculumProficiencyAssessment.CLASS_ATTRIBUTE_IDENTIFIER, AdaptiveLearningQuizWebVO.CLASS_ATTRIBUTE, IHierarchicalLMSContent.CLASS_ATTRIBUTE_IDENTIFIER}
)
public class CurriculumProficiencyAssessmentAdminController {
    ...
    public String addCurriculumAssessment(Model model, ModelMap modelMap, @RequestParam("curriculumID") Long curriculumID) {
        ...
        modelMap.addAttribute(IHierarchicalLMSContent.CLASS_ATTRIBUTE_IDENTIFIER, eLearningCurriculum);
    ...
    public String addCurriculumAssessment(Model model,
                                          ...
                                          @ModelAttribute(IHierarchicalLMSContent.CLASS_ATTRIBUTE_IDENTIFIER) ELearningCurriculum eLearningCurriculum) {
